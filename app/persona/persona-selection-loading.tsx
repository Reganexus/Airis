...
const PersonaCardSkele: React.FC = () => {
  return (
    <div
      className={`bg-slate-300 rounded-2xl min-h-36 border border-slate-300 shadow-sm relative overflow-clip`}
    >
      ...
      <div className="absolute bg-white w-full rounded-t-2xl bottom-0 left-0 h-[80%] flex flex-col p-4 pt-9 pl-4 ">
        <span className="absolute top-2 right-2 text-xs py-1 px-2 bg-airis-primary bg-opacity-15 rounded-2xl text-airis-primary font-semibold text-opacity-0 overflow-clip">
          Selected
          <span className="absolute inset-0 transform -translate-x-full bg-gradient-to-r from-slate-100 via-slate-200 to-slate-100 animate-shimmer"></span>
        </span>

        <div className="w-[50px] h-[50px] rounded-full border-4 border-white bg-slate-200 absolute top-[-15px] left-3 overflow-clip">
        ...
        <h3 className="text-slate-700 font-bold self-start bg-slate-300 text-opacity-0 rounded-md relative overflow-clip">
          <div className="absolute inset-0 transform -translate-x-full bg-gradient-to-r from-slate-300 via-slate-400 to-slate-300 animate-shimmer opacity-25"></div>
          AI NAME HERE
        </h3>
        <p className="text-xs text-slate-500 m-0 inline bg-slate-100 my-1 rounded-sm text-opacity-0 relative overflow-clip">
          <div className="absolute inset-0 transform -translate-x-full bg-gradient-to-r from-slate-300 via-slate-400 to-slate-300 animate-shimmer opacity-25"></div>
          Line here blah lorem ipsum skibidi
        </p>
        <p className="text-xs text-slate-500 m-0 inline bg-slate-100 rounded-sm text-opacity-0 relative overflow-clip">
          <div className="absolute inset-0 transform -translate-x-full bg-gradient-to-r from-slate-300 via-slate-400 to-slate-300 animate-shimmer opacity-25"></div>
